...
{  
    ...
    HAL_TIM_Base_Start_IT(&TIM7_Handler); //Ê¹ÄÜ¶¨Ê±Æ÷3ºÍ¶¨Ê±Æ÷3¸üÐÂÖÐ¶Ï£ºTIM_IT_UPDATE    
}
...
{  
    ...
    HAL_TIM_Base_Start_IT(&TIM5_Handler); //Ê¹ÄÜ¶¨Ê±Æ÷3ºÍ¶¨Ê±Æ÷3¸üÐÂÖÐ¶Ï£ºTIM_IT_UPDATE    
}
...
{  
    ...
    HAL_TIM_Base_Start_IT(&TIM2_Handler); //Ê¹ÄÜ¶¨Ê±Æ÷6ºÍ¶¨Ê±Æ÷6¸üÐÂÖÐ¶Ï£ºTIM_IT_UPDATE  
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef *htim)
{
    if(htim->Instance==TIM5)
	{
		...
		HAL_NVIC_EnableIRQ(TIM5_IRQn);          //¿ªÆôITM3ÖÐ¶Ï   
	}  
	   if(htim->Instance==TIM2)
	{
		__HAL_RCC_TIM2_CLK_ENABLE();            //Ê¹ÄÜTIM5Ê±ÖÓ

		HAL_NVIC_SetPriority(TIM2_IRQn,1,3);    //ÉèÖÃÖÐ¶ÏÓÅÏÈ¼¶£¬ÇÀÕ¼ÓÅÏÈ¼¶1£¬×ÓÓÅÏÈ¼¶3
		HAL_NVIC_EnableIRQ(TIM2_IRQn);          //¿ªÆôITM3ÖÐ¶Ï   
	} 
		if(htim->Instance==TIM7)
	{
		__HAL_RCC_TIM7_CLK_ENABLE();            //Ê¹ÄÜTIM5Ê±ÖÓ

		HAL_NVIC_SetPriority(TIM7_IRQn,1,3);    //ÉèÖÃÖÐ¶ÏÓÅÏÈ¼¶£¬ÇÀÕ¼ÓÅÏÈ¼¶1£¬×ÓÓÅÏÈ¼¶3
